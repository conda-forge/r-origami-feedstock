...
Once the `conda-forge` channel has been enabled, `r-origami` can be installed with:

```
conda install r-origami
```

It is possible to list all of the versions of `r-origami` available on your platform with:
